        ...
        try {
            ...
            if (uri) {
                ...
                try {
                    ...
                    console.log("Saving recording to consistent location:", finalAudioPath)
                    ...
                    try {
                        ...
                        const result = await processAudioForTranscription(finalAudioPath, true)
                        ...
                        console.error("Error processing audio with AI:", processingError)
                    ...
                    setRecordingStatus("idle")
                    setIsProcessing(false)
                    Alert.alert("Error", `Failed to prepare audio file: ${error.message}`)
                }
            } else {
                setRecordingStatus("idle")
                setIsProcessing(false)
    ...
    return (
        <View style={styles.container}>
            <View style={styles.timerContainer}>
                ...
                {(recordingStatus === "processing" || recordingStatus === "transcribing") && (
                ...
                {recordingStatus === "idle" ? (
                    ...
                    <View style={styles.loadingContainer}>
                        ...
                        <Text style={styles.loadingText}>
                            {recordingStatus === "transcribing" ? "This may take a minute..." : "Processing audio..."}
                        </Text>
                    </View>
                ) : (
